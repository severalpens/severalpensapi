...
let alice = require('./seed/alice.json');
let bob = require('./seed/bob.json');
let btc = require('./seed/btc.json');
let bt = require('./seed/bt.json');
let hashPair1 = require('./seed/hashPair1.json');
let amount = require('./seed/amount.json');
let seedAmount = require('./seed/seedamount.json');
